  ...
  <body <?php body_class(); ?>>
    <!--[if lt IE 9]>
      <div class="alert alert-warning">
        <?php _e('You are using an <strong>outdated</strong> browser. Please <a 
      ...
      <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        ...
        <div class="mdl-layout__content basemdl-container" role="document">
          <div class="mdl-grid">
            ...
            ?>
            <main class="mdl-cell <?php echo $col; ?> mdl-shadow--2dp mdl-color--white basemdl-content" role="main">
